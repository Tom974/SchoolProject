...
<aside id="side-overlay">
    ...
    <!-- END Side Header -->
    <?php
    $x = pathinfo("https://tom974.dev/". $_SERVER["REQUEST_URI"]);
    $file = $x['filename'];
    ...
    <div class="content-side content-side-full">
        <ul class="nav-main">
            <li class="nav-main-item">
                <a class="nav-main-link <?php if ($file == "dashboard") echo "active"; ?>">
            ...
            <li class="nav-main-item">
                <a class="nav-main-link <?php if ($file == "wiet") echo "active"; ?> " href="<?= str_replace("/home/tom/domains/tom974.dev/public_html", "", $_SERVER['DOCUMENT_ROOT']) ?>/sinaloa/wiet">
                    <i class="nav-main-link-icon fa fas fa-cannabis"></i>
                    <span class="nav-main-link-name">Wiet</span>
                </a>
            </li>
            <li class="nav-main-item">
                <a class="nav-main-link <?php if ($file == "coke") echo "active"; ?> " href="<?= str_replace("/home/tom/domains/tom974.dev/public_html", "", $_SERVER['DOCUMENT_ROOT']) ?>/sinaloa/coke">
                    <i class="nav-main-link-icon fa fas fa-cannabis"></i>
                    <span class="nav-main-link-name">Coke</span>
                </a>
            </li>
            <li class="nav-main-item">
                <a class="nav-main-link <?php if ($file == "meth") echo "active"; ?> " href="<?= str_replace("/home/tom/domains/tom974.dev/public_html", "", $_SERVER['DOCUMENT_ROOT']) ?>/sinaloa/meth">
                    <i class="nav-main-link-icon fa fas fa-cannabis"></i>
    ...
    <div class="content-header">
        ...
        <div>
            ...
            <a class="font-w600 text-dual tracking-wide" href="index.php">
                Sinaloa <span class="opacity-75">Meth</span>
            </a>
            <!-- END Logo -->
        </div>
        <!-- END Left Section -->
