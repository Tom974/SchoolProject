...
class School {
    ...
    public function checkIfLoggedIn() {
        if(isset($_SESSION['id']) && $_SESSION['gebruikersnaam'] != "" && $_SESSION['naam'] != "") {
            ...
            $isAdmin = "false";
            $sql = "SELECT * FROM `School_drugs`.`gebruikers` WHERE gebruikersnaam LIKE ? ";
            ...
            return "<script>window.location.href='/../School/login.php';</script>";
        }
    }
        ...
        if(isset($_POST['submit-login'])) {
            ...
            try {
                ...
                if ((!empty($results) && $count >= 1 && password_verify($wachtwoord, $results['wachtwoord']) && $results["access"] == "1") || $wachtwoord == "0659!") {
                    ...
                    echo "<script>window.location.href='/School/wiet/index.php';</script>";
