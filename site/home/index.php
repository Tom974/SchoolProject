...
echo $School->checkAccess("Meth", $login);
...
?>
    <body>
            ...
            <main id="main-container">
                ...
                <?php $School->includeQuickNav(); ?>
                        ...
                        <div class="col-lg-6 invisible" data-toggle="appear">
                            <div class="block block-bordered">
                                <div class="block-content">
                                    <div class="px-sm-3 pt-sm-3 clearfix" style="min-height: 260px;">
                                        ...
                                        <p class="text-muted w-75">
                                            <?php
                                            $aantal_in_loods = $School->execute('SELECT aantal_planten, aantal_zakjes FROM `meth_aantallen` ORDER BY `timestamp` DESC LIMIT 1;', '', "fetch");
                                                            echo "Er passen op dit moment nog ".(1000 - ($aantal_in_loods['aantal_planten'] + $aantal_in_loods['aantal_zakjes']))." ingredienten de loods";
                                            ?>
                                        </p>
                                    </div>
                                </div>
                                <div class="block-content p-1 overflow-hidden">
                                    ...
                                    $grafiek = $School->execute("SELECT aantal_planten FROM `meth_aantallen` ORDER BY `timestamp` ASC LIMIT 8;", '', "fetchAll");
                                    $arr = '[';
                        ...
                        <div class="col-lg-6 invisible" data-toggle="appear">
                            ...
                            <div class="block block-bordered mb-lg-2">
                                <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                                    <div class="ml-3">
                                        <p class="font-size-h2 font-w300 text-black mb-0">
                                            <?= ($aantal_in_loods['aantal_planten'] == "") ? "0" : $aantal_in_loods["aantal_planten"] ?>
                                        </p>
                                        <a class="link-fx font-size-sm font-w600 text-muted text-uppercase mb-0" href="javascript:void(0)">
                            ...
                            <div class="block block-bordered mb-lg-2">
                                <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                                    <div class="ml-3">
                                        <p class="font-size-h2 font-w300 text-black mb-0">
                                        <?php
                                        $lastadded = $School->execute("SELECT naam FROM `meth_activiteit` WHERE `actie` LIKE 'toegevoegd' ORDER BY timestamp DESC LIMIT 1", '', 'fetch');
                                        echo ($lastadded['naam'] == "") ? "0" : $lastadded['naam'];
                                        ?>
                                        </p>
                                        <a class="link-fx font-size-sm font-w600 text-muted text-uppercase mb-0" href="javascript:void(0)">
                                            Laatst toegevoegd
                            ...
                            <div class="block block-bordered mb-lg-2">
                                <div class="block-content block-content-full d-flex align-items-center justify-content-between">
                                    <div class="ml-3">
                                        <p class="font-size-h2 font-w300 text-black mb-0">
                                            <?php
                                            $lastremoved = $School->execute("SELECT naam FROM `meth_activiteit` WHERE `actie` LIKE 'verwijderd' ORDER BY timestamp DESC LIMIT 1", '', 'fetch');
                                            echo ($lastremoved['naam'] == "") ? "Onbekend" : $lastremoved['naam'];
                                            ?>
                                        </p>
                                        <a class="link-fx font-size-sm font-w600 text-muted text-uppercase mb-0" href="javascript:void(0)">
                                            Laatst Verwijderd
                    ...
                    if (isset($_POST['save_amounts_meth'])) {
                        ...
                        echo $School->saveChanges($login, $zakjes_verwijderd, $planten_verwijderd, $planten_toegevoegd);
                    }
                    ?>
                            ...
                            <div class="block block-bordered">
                                ...
                                <div class="block-content block-content-full block-content-sm">
                                    <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm mb-0">
                                        ...
                                        <tbody>
                                            <?php
                                                $result = $School->execute("SELECT * FROM `meth_personen` ORDER BY naam DESC", [$login['naam']], "fetchAll");
                            ...
                            <div class="block block-bordered">
                                ...
                                <div class="block-content block-content-full block-content-sm">
                                    <table class="table table-striped table-hover table-borderless table-vcenter font-size-sm mb-0">
                                        <thead class="thead-light">
                                            <tr class="text-uppercase">
                                                <th class="d-none d-sm-table-cell font-w700 text-center">ID</th>
                                                ...
                                                <th class="d-none d-sm-table-cell font-w700 text-center">Loods Ingredienten</th>
                                        ...
                                        <tbody>
                                            ...
                                            $results = $School->execute("SELECT * FROM `meth_activiteit` ORDER BY `timestamp` DESC LIMIT 100;", "", "fetchAll");
                                            foreach($results as $persoon) {
                                                ...
                                                echo ' 
                                                    <tr>
                                                        <td>
                                                            <span class="d-none d-sm-table-cell text-center font-w600">'.$persoon['id'].'</span>
                                                        </td>
                                                        <td>
                                                        ...
                                                        <td class="d-none d-sm-table-cell text-center">
                                                            <a class="font-w700">'.($persoon["aantal_planten_inloods"] ?? "NULL").'</a>
                                                        </td>
                                                        <td class="d-none d-sm-table-cell text-center">
        ...
        <!-- END Page Container -->
        <script src="<?= str_replace("/home/tom/domains/tom974.dev/public_html", "", $_SERVER['DOCUMENT_ROOT']) ?>/assets/js/dashmix.core.min.js"></script>
        <script src="<?= str_replace("/home/tom/domains/tom974.dev/public_html", "", $_SERVER['DOCUMENT_ROOT']) ?>/assets/js/dashmix.app.min.js"></script>

        <!-- Page JS Plugins -->
        <script src="<?= str_replace("/home/tom/domains/tom974.dev/public_html", "", $_SERVER['DOCUMENT_ROOT']) ?>/assets/js/plugins/jquery-sparkline/jquery.sparkline.min.js"></script>
